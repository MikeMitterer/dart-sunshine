...
part 'stores/SunshineStoreImpl.dart';

/// Basic DI configuration for this Application-[DataStore]
///
/// Usage:
...
class StoreModule  extends di.Module {
    StoreModule() {
        bind(SunshineStore,toImplementation: SunshineStoreImpl);
    }
}
